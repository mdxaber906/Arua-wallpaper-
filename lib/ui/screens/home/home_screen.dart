                        ...
                        Expanded(
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: const Text('Latest', style: const TextStyle(color: Colors.white70, fontWeight: FontWeight.w700)),
                            ),
                          ),
                        ),
                        Expanded(
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              alignment: Alignment.center,
                              child: const Text('Live', style: const TextStyle(color: Colors.white70, fontWeight: FontWeight.w700)),
                            ),
                          ),
                        ),
                      ],
